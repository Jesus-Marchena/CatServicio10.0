    ...
    for (var i in leer){
      ...
      if(nombre!="" && categoria!=""){
         if(leer[i].categoria == categoria && leer[i].nombre == nombre){
            ...
            string='<center><IMG SRC="'+leer[i].imagen+'" class="img-responsive" width="200px"><h3>'+leer[i].nombre+'</h3><button id="'+leer[i].idss+'" class="btn btn-primary leermas">Leer Mas</button> <button id="'+leer[i].idss+'" class="btn btn-default modificar">Modificar</button></center>';
...
$(document).on("click",'.submit',function(){
              ...
              window.open('https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=MGH3RARQ9FEHG', '_system', 'location=yes');
